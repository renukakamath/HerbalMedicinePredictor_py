...
public class Useraddproduct extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_useraddproduct);
        ...
        e1.setText(VieworsearchPlants.plants);
        e1.setEnabled(false);
        e2.setText(VieworsearchPlants.qtys);
        e2.setEnabled(false);
        e3.setText(VieworsearchPlants.rates);
        e3.setEnabled(false);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (e5.getText().toString().equalsIgnoreCase("")) {
                    ...
                    JR.json_response=(JsonResponse)Useraddproduct.this;
                    String q="/purchaseplant?lid="+sh.getString("log_id","")+"&pid="+VieworsearchPlants.pids+"&qty="+e4.getText().toString()+"&amount="+e5.getText().toString();
                    q=q.replace(" ","%20");
                    JR.execute(q);
                }
            }
